...
in the traditional \acs{fl} setting, the local loss function at client $i$ is denoted by $f_i$. For personalized compressed model training, we define the following augmented loss function at client $i$:
\begin{equation*}
    \begin{split}

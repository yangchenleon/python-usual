...
def tex2txt2(tex_file):

    if(re.search('.tex$',tex_file)==None):
        sys.exit('The input should be .tex file. Exit.')

    print('LaTeX file:',tex_file)

    with open(tex_file, 'r', encoding='utf-8') as source_file:
